...
if __name__ == "__main__":
    # 基隆路幹線
    route_id_1 = "0100000A01"  # 基隆路幹線的路線 ID
    print(f"正在抓取基隆路幹線 ({route_id_1}) 的資料...")
    go_df_1, back_df_1 = scrape_bus_route(route_id_1)
    
    # 承德幹線
    route_id_2 = "0100000A02"  # 承德幹線的路線 ID
    print(f"正在抓取承德幹線 ({route_id_2}) 的資料...")
    go_df_2, back_df_2 = scrape_bus_route(route_id_2)
